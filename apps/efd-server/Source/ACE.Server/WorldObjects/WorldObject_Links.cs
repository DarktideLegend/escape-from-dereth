    ...
    partial class WorldObject
    {
        ...
        public void ActivateLinks(List<LandblockInstance> sourceObjects, List<Biota> biotas, WorldObject parent = null)
        {
            ...
            foreach (var link in LinkedInstances)
            {
                ...
                wo.Location = new Position(link.ObjCellId, link.OriginX, link.OriginY, link.OriginZ, link.AnglesX, link.AnglesY, link.AnglesZ, link.AnglesW, parent?.Location?.Instance ?? 0);
