    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<bool>> DefaultBooleanProperties =
            DictOf(
                ...
                ("corpse_destroy_pyreals", new Property<bool>(false, "If FALSE then pyreals will not be completely destroyed on player death")),
                ...
                ("fellow_busy_no_recruit", new Property<bool>(false, "if FALSE, fellows can be recruited while they are busy, different from retail")),
                ...
                ("rares_real_time", new Property<bool>(false, "allow for second chance roll based on an rng seeded timestamp for a rare on rare eligible kills that do not generate a rare, rares_max_seconds_between defines maximum seconds before second chance kicks in")),
                ...
                ("suicide_instant_death", new Property<bool>(true, "if enabled, @die command kills player instantly. defaults to disabled, as in retail")),
                ...
                ("use_turbine_chat", new Property<bool>(false, "enables or disables global chat channels (General, LFG, Roleplay, Trade, Olthoi, Society, Allegience)")),
                ("use_wield_requirements", new Property<bool>(false, "disable this to bypass wield requirements. mostly for dev debugging")),
                ("version_info_enabled", new Property<bool>(false, "toggles the /aceversion player command")),
                ("vendor_shop_uses_generator", new Property<bool>(true, "enables or disables vendors using generator system in addition to createlist to create artificial scarcity")),
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("pk_new_character_grace_period", new Property<double>(0, "the number of seconds, in addition to pk_respite_timer, that a player killer is set to non-player killer status after first exiting training academy")),
                ...
                ("rare_drop_rate_percent", new Property<double>(0, "Adjust the chance of a rare to spawn as a percentage. Default is 0.04, or 1 in 2,500. Max is 100, or every eligible drop.")),
                ...
                ("void_pvp_modifier", new Property<double>(0.1, "Scales the amount of damage players take from Void Magic. Defaults to 0.5, as per retail. For earlier content where DRR isn't as readily available, this can be adjusted for balance.")),
